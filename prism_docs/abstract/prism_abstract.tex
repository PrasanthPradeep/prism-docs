...
\vfill
\textbf{GROUP 1 Team Members:}

\begin{flushright}
\textbf{NOBIN SIJO} \hspace{0cm} \textbf{(KNP23CS082)}\\
\textbf{PRANAV P} \hspace{0cm} \textbf{(KNP23CS085)}\\
\textbf{PRASANTH P} \hspace{0cm} \textbf{(KNP23CS086)}\\
\textbf{SANKAR NARAYAN S} \hspace{0cm} \textbf{(KNP23CS094)}
\end{flushright}
